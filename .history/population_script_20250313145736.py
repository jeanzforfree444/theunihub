...
def create_articles(users, categories):
    ...
    article_data = [
        {"category": "Academics","title": "Student Advisers: What Do They Do?","summary": "Student advisers play a crucial role in guiding students through their academic journey. Learn how they can help you with course selection, career advice, and more.",
         "content": "Student advisers are dedicated professionals who assist students in navigating their academic paths. They provide guidance on course selection, degree requirements, and career planning. Advisers also help students overcome academic challenges and connect them with resources like tutoring or mental health services. Building a strong relationship with your adviser can significantly enhance your university experience.","university": ""},
        {"category": "Academics","title": "How to Ace Your Finals: Expert Tips","summary": "Struggling with finals? Discover expert tips to help you study effectively, manage stress, and perform your best during exam season.",
         "content": "Finals can be overwhelming, but with the right strategies, you can ace them. Start by creating a study schedule that breaks down your material into manageable chunks. Use active learning techniques like flashcards and practice exams. Don’t forget to take breaks and prioritize sleep to keep your mind sharp. On exam day, stay calm, read questions carefully, and manage your time wisely. Remember, preparation is key to success!","university": ""},
        ...
        {"category": "Accommodation","title": "Campus vs. Private: What's Best for You?","summary": "Deciding between campus and private accommodation? Compare the pros and cons to find the best fit for your lifestyle and budget.",
         "content": "Campus accommodation is ideal for students who want to be close to classes and university facilities. It often includes meal plans and a built-in social network. On the other hand, private accommodation offers more freedom and flexibility, allowing you to choose your location and housemates. However, it may require more responsibility for bills and maintenance. Consider your priorities, budget, and preferences to make the right choice.","university": ""},
        {"category": "Accommodation","title": "Murano Accommodation: Quick Tour & Guide","summary": "Murano Student Village is a popular accommodation option for University of Glasgow students. Here’s what you need to know about living there.",
        ...
        {"category": "Career","title": "Building a Strong CV: Tips for University Students","summary": "A strong CV is essential for landing internships and jobs. Learn how to highlight your skills, experiences, and achievements effectively.",
        ...
        {"category": "Career","title": "How to Network Effectively as a Student","summary": "Networking is a valuable skill for students. Discover tips on building professional relationships and expanding your career opportunities.",
        ...
        {"category": "Career","title": "Internships: How to Find the Right One for You","summary": "Internships are a great way to gain experience and boost your career prospects. Learn how to find and secure the perfect internship.",
