...
def create_users():
    ...
    user_data = [
        ...
        {'username': 'urangoo123', 'first_name': 'Urangoo', 'last_name': 'Ganzorig', 'email': 'urangoo_ganzorig@live.com', 'password': 'OceanBreeze29&', 'staff': True, 'superuser': False, 'bio': 'The brains behind this websites system.', 'university': 'dundee', 'school': 'Health Sciences', 'department': 'Nursing', 'degree': 'Adult Nursing', 'start': 2024},
        {'username': 'ailsa_brown03', 'first_name': 'Ailsa', 'last_name': 'brown', 'email': 'alisa_brown@icloud.com', 'password': 'RiverFlow63@', 'staff': False, 'superuser': False, 'bio': 'Switched my university and my degree and now I love being a student.', 'university': 'strathclyde', 'school': 'Life Sciences', 'department': 'Sports', 'degree': 'Sports Science', 'start': 2025},
